...
<body class="bg-gradient-primary">
                                    ...
                                    <form class="user" action="login" method="POST">
                                        <div class="form-group">
                                            <input type="email" name="email" class="form-control form-control-user"
                                                ...
                                                placeholder="O seu email aqui..." required>
                                        </div>
                                        <div class="form-group">
                                            <input type="password" name="password" class="form-control form-control-user"
                                                id="password" placeholder="A sua senha aqui..." required>
                                        </div>
                                        <hr>
    ...
    <?php if(! empty($error) ): ?>
        ...
        <div aria-live="polite" aria-atomic="true" class="d-flex justify-content-center align-items-center" style="min-height: 200px;">
            ...
            <div class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-autohide="false" style="position: absolute; top: 15px;">
                <div class="toast-header">
                    <strong class="mr-auto">Falha ao logar</strong>
